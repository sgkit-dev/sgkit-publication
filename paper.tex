...
\begin{itemize}
\item \textbf{Storing genetic variation data}. High level discussion of
...
\item \textbf{Computing on the genotype matrix}.
...
\item \textbf{Subsetting the genotype matrix}.
...
Forward ref to following sections on applications.

\item \textbf{Quality control of large datasets}
...
the dataset, using a good size distributed cluster. Quote
times.

\item \textbf{Statistical genetics}
